...
!
!  NG
!    Run the NG acceleration algorithm
!
!#####################################################################
!#####################################################################
!#####################################################################
...
!#####################################################################
      ...
      !!       L(integer): Dimension of the atomic part of the
      !!                   vector\n
      !!       N(integer): Order of the NG acceleration\n
      !!  YY(double(:,:)): Matrix with memory of the vector to
      !!                   accelerate\n
      ...
      do i=1,N
        do k=1,L
          ...
          ! Accelerate and store in last entry
        ...
        do k=L+1,M
          ...
          do i=1,N
            ...
            do j=1,N
              ...
              A(i,j) = A(i,j) + &
                       DI*(DY + YY(k,ntry-j) - YY(k,ntry-j-1))
